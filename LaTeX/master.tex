...
\documentclass[fontsize=12pt,BCOR=5mm,DIV=12,parskip=half,listof=totoc,
               paper=a4,toc=bibliography,pointlessnumbers,ngerman]{scrreprt}
...
%
\ArtDerArbeit{Bachelor} % "Bachelor" oder "Projekt" wählen
\TitelDerArbeit{Entwicklung einer Video-Streaming-Lösung für HB10 Dart Geräte}
\AutorDerArbeit{David Herrmann}
\Abteilung{F\&E}
\Firma{LÖWEN ENTERTAINMENT}
\Kurs{TINF23AI1}
\Studienrichtung{Duale Hochschule Baden-Würtemberg Mannheim}
\Matrikelnummer{3428675}
\Studiengangsleiter{Proffesor Holger Hofmann}
\WissBetreuer{Proffesor Holger Hofmann}
\FirmenBetreuer{Knud Weinard}
\Bearbeitungszeitraum{02.06.2026 -- 25.08.2026}
...
%
%\input{Front/nondisclosurenotice} 
%\cleardoublepage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\input{Chapters/Teschnologien}
\input{Chapters/Architektur}
\input{Chapters/Dart}
\input{Chapters/Server}
\input{Chapters/Webplattform.tex}
