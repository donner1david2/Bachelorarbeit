...
und verbindet mit dem HB10 traditionelle E-Dart-Funktionen mit digitalen Erweiterungen. Gerade im Breitensport ist Dart heute sehr beliebt. Dadurch haben sich über den Verlauf der letzten Jahre nationale Ligen und Turnier-Serien etabliert, die durch offizielle Verbände, wie den \ac{DSAB} veranstaltet werden.
Der HB10 wird als offizielles \ac{DSAB}-Liga- und Turniergerät eingesetzt und bietet verschiedene Spielvarianten, Trainingsspiele sowie einen Turniermodus. 
...
Das größte Turnier dieser Art fand vor kurzem mit über 4.000 aktivem Spielern und über 250 HB10 statt \cite{2026}. Diese synchronen Turnierformen setzen voraus, dass die Teilnehmer innerhalb eines gemeinsamen zeitlichen Rahmens und am selben HB10 am Wettbewerb teilnehmen. 
...
durch in das Gerät integrierte Kameras erfasst und als kurze Videosequenzen zwischengespeichert. Nach Abschluss des Spiels werden diese einzelnen Videoschnipsel in eine zeitlich geordnete Form gebracht, zu einem zusammenhängenden Video zusammengefügt und anschließend an einen Server übertragen.
...
die eine Überprüfung vergangener Spiele durch die Nutzer ermöglicht. Um dies zu erreichen, muss zunächst ein Konzept für das Streaming-System entwickelt werden (s. \cref{sec:system}). Daraufhin muss eine Kamera in den HB10 integriert und das Gerät um die Funktion erweitert werden, 
die von der Kamera aufgenommenen Videos für das \ac{VOD}-Streaming aufzubereiten (s. \cref{sec:dart}). Anschließend ist ein Server zu entwickeln, welcher die Videos des HB10 empfängt, zwischenspeichert und auf Anfrage des Nutzers bereitstellt (s. \cref{sec:server}). Zuletzt wird eine Webplattform erstellt, 
über welche die Nutzer die gespeicherten Videos ansehen können (s. \cref{sec:web}).
