...
Diese Arbeit beschafft sich mit der Realisierung einer \ac{VOD} Streaming Platform für das LÖWEN-Dart HB10, die eine Überprüfung vergangener Spiele durch die Nutzer ermöglicht. Um dies zu erreichen, muss zunächst ein Konzept für das System des Streamings entwickelt werden.
Daraufhin muss eine Kamera in den HB10 integriert werden, und der HB10 um die Funktion erweitert werden, die von der Kamera aufgenommenen Videos für das \ac{VOD} Streaming an die Nutzer vorzubereiten. Anschließend daran ist es notwendig, einen Server \todo{vlt anpassen} zu entwickeln,
