...
und verbindet mit dem HB10 traditionelle E-Dart-Funktionen mit digitalen Erweiterungen. Gerade im Breitensport ist Dart heute sehr beliebt. Dadurch haben sich über den Verlauf der letzten Jahre nationale Ligen und Turnier-Serien etabliert, die durch offizielle Verbände, wie den \ac{DSAB}\cite{https://dsab-vfs.de/} veranstaltet werden.
...
Diese Arbeit befasst sich mit dem Konzept und der Umsetzung eines Prototypens für eine \ac{VOD}-Streaming-Plattform \todo{alternative suchen} für das \textit{LÖWEN DART HB10}, 
