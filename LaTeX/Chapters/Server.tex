...
\begin{figure}[H]
    ...
    \caption{Lebenszyklus eines Videos}
...
Auf er anderen Seite, besteht auch die Möglichkeit die Funktionalität in den bestehenden Dart-Server zu integrieren. Da der Dart-Server bereits über eine Angebundene PostgreSQL Datenbank, und verschiedene REST-API-Endpunkte verfügt, sollte sich diese Integration relativ simpel gestalten.
...
\subsection{Datenminimierung und Hintergrundausblendung}
