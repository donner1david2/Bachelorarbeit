...
Für das Speichern und Bereitstellen der Videos wird ein Server benötigt, der die empfangenen Videodaten und deren Metadaten speichert und auf Anfrage eines Nutzers bereitstellt. Dieser muss dabei in der Lage sein, eine größere Menge Anzahl an Nutzern gleichzeitig zu bedienen.
...
Dies ist mittlerweile eine empfohlene Praxis bei \ac{VOD} Streaming Plattformen \cite{aws_media_storage}. Object-Storage bringt jedoch viel Komplexität mit sich, die nicht gerechtfertigt werden kann. Denn die Größenordnung der Anzahl an Videos mit denen zu rechnen ist, 
...
Es braucht deutlich reduzierten Aufwand einen REST-Server mittels Spring Boot aufzustellen. Spring Boot übernimmt den Großteil der Aufgaben und es müssen nur die Endpunkte für die Clients, die Schnittstellen zur Datenbank und wie Erhaltene Anfragen bearbeitet werden müssen definiert werden.
Da eine große Menge strukturierter Video-Metadaten gespeichert werden, wurde eine relationale Datenbank zur effizienten Verwaltung dieser Daten eingesetzt.
