...
Dieser wert kann entweder als Statistik zum sortieren verwendet werden, oder im Fall das man die Videolänge angeben möchte können wir diese mit den Würfen berechnen da wir wissen ein Wurf entspricht genau 3 sek. 
...
Das Datenmodell bleibt damit bewusst klein gehalten. Für den Prototypen reicht diese Struktur aus, da zunächst nur der Upload, die Speicherung, die Zuordnung und der Abruf der Videos umgesetzt werden müssen. Eine spätere Erweiterung wäre dennoch möglich. 
...
Für die Kommunikation zwischen dem Server und den Clients werden REST-API-Endpunkte bereitgestellt. Diese Endpunkte ermöglichen es den Clients, Videos hochzuladen, Metadaten abzurufen und Videos zu streamen \cref{fig:videocycle} . Die API-Endpunkte sind wie folgt strukturiert:
