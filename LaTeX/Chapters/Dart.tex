...
\subsubsection{Initialisierung des Systems und Aufbau der Kommunikation}
...
\subsubsection{Kontinuierliche Erfassung und Zwischenspeicherung der Bilddaten}
...
Der letzte Teil ist zuständig für den fachlichen Ablauf, der von einem registrierten Wurf bis zur späteren Bereitstellung des zugehörigen Videos reicht. Im Mittelpunkt steht die Zusammenarbeit zwischen \texttt{Dart\_App}, \texttt{Video\_Main}, \texttt{File\_System} und \texttt{Server}. 
...
Für die Kommunikation zwischen Dart\_App und Video\_App wird eine Socket Verbindung verwendet. Die Video\_App wartet auf eine Verbindung der Dart\_App, und ist Anschließend bereit Ereignisse mit zusätzlichen Daten zu erhalten.
