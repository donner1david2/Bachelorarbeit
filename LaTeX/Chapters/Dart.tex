...
Der HB10  besteht aus einer Hauptanwendung in welcher der normale Spielbetrieb abläuft, und mehreren "Satellit"-Anwendungen welche sich auf eine bestimmte Funktionalität spezialisiert sind. Zum Beispiel der Update-Server, welcher dafür zuständig ist, das Gesamte System zu updaten.
Für die Aufnahme-Funktion des HB10 würde eine solche Anwendung erstellt (siehe Video App in \ref{fig:dartaufbau}).
...
Die Videofunktion des HB10 erstreckt sich über zwei Anwendungen, welche miteinander kommunizieren (s. \ref{fig:videoaufbau}). Die erste ist die eigentliche DART-Anwendung, diese ist dafür zuständig die zweite Anwendung über Ereignisse wie Treffer, Spiel Start und Ende zu Informieren,
...
Die Dart\_App bildet die zentrale Anwendung für den eigentlichen Spielbetrieb des HB10 (s. \ref{fig:dartaufbau}). Sie verwaltet die Spiellogik, verarbeitet spielbezogene Eingaben und stellt die für den Betrieb des Geräts notwendigen Funktionen bereit. 
...
Im ersten Bereich der Video\_App findet der Aufbau der Verbindung zwischen den beteiligten Komponenten sowie die Herstellung der Betriebsbereitschaft für die spätere Videoaufnahme (s. \ref{fig:dartsequenz1}). Sichtbar wird insbesondere, 
...
Im zweiten Teil finden der periodische Empfang von Bilddaten aus der Kamera sowie deren Zwischenspeicherung innerhalb des Systems statt (s. \ref{fig:dartsequenz2}). Anders als im ersten Teil, der die Initialisierung zeigt, und der dritte Teil, der sich auf Spielereignisse konzentriert, 
