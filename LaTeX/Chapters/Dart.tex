...
und mehreren \enquote{Satellit}-Anwendungen welche auf eine bestimmte Funktionalität spezialisiert sind entwickelt. Ein Beispiel dafür ist der sogenannte "Update-Server", welcher dafür zuständig ist, das gesamte System zu updaten.
...
welches für die Spiele-Logik und Geldverarbeitung verantwortlich ist, und einem zweiten Rechner welcher für den anspruchsvollere Anwendungen, wie zum Beispiel die Grafik, zuständig ist. Da nur der Teil auf dem Secure-Modul relevant für Prüfungen der \ac{PTB}\cite{https://www.ptb.de/cms/ptb/fachabteilungen/abt8/fb-85/ag-853.html} ist, 
können die anderen Komponenten auf dem zweiten Rechner deutlich einfacher im Fehlerfall aktualisiert werden. Die Kommunikation der einzelnen Komponenten geschieht dabei über Sockets  über Ethernet. Beim HB10 laufen alle Komponenten auf dem AMD Ryzen System, sodass die Ethernetverbindung an dieser Stelle entfällt. 
...
Die Kamera (Modell:  ELP-USB3MP01HL29)\cite{https://www.elpcctv.com/3mp-h264-ar0331-cmos-wdr-camera-module-usb-with-29mm-wide-angle-lens-for-vehicle-video-surveillanc-p-283.html } dient als Videoquelle für die Aufnahmen des Spielers und der Dartscheibe. Für den Prototypen gibt es zunächst eine Kamera, 
später wird der HB10 jeweils eine Kamera für den Spieler und die Dartscheibe besitzen. Die angewandte Kamera bietet verschiedene Videoformate in Verschiedenen Auflösungen und Bildwiederholfrequenzen an. Für die Videoaufnahme am HB10 wurde das einzige unkomprimierte Format der Kamera gewählt, 
