...
die Abläufe in und zwischen diesen Komponenten folgt anschließend in \cref{sec:dart-ablauf} \todo{itemizeation}
...
Die bestehende Software des HB10 sowie die im Rahmen dieser Arbeit erweiterte Dart-Anwendung sind in C++ implementiert. Für die Verarbeitung der Videodaten wurde zusätzlich FFmpeg eingebunden. 
...
\begin{figure}[h]
    ...
    \caption{Architektur und Datenfluss der Video-App. Die Anwendung verarbeitet von der Kamera bereitgestellte rohe(YUYV) Videodaten, speichert diese zunächst in einem Ringpuffer und erzeugt daraus ereignisbasierte Videoausschnitte sowie fertige Videos. 
...
verwendet. \todo{konsequenzen Software Komprimierung}
